...
public class MyLinkedList<E>  {
  ...
  public MyLinkedList<E> getUnique(MyLinkedList<E> param)
  {
    Node<E> cList = this.head;
    //Node<E> pList = param.head;
    boolean flag;
      ...
      while(cList.next != null)
      {
        cList = cList.next;
        flag = true;
        for(Node<E> pList = param.head; pList.next != null; pList = pList.next)
        {        
          if(cList.element == pList.element)
          {
            flag = false;
          }
        }
